...
const EventCard = ({ instaLink, imgLink, title, info, date }) => {
  ...
  return (
    <div className="flex flex-row  p-5 shadow-md rounded-md gap-5 bg-gray-50 hover:-translate-y-2 transition-all w-[40rem] mx-auto">
      <img src={imgLink} alt="" className="w-[15rem] rounded-md" />
      <div className="flex flex-col gap-3 tracking-wider w-[20rem]">
