...
const EventCard = ({ instaLink, imgLink, title, info, date }) => {
  ...
  return (
    <div className="flex flex-col 12xl:flex-row  p-5 shadow-md rounded-md gap-5 bg-gray-50 8xl:hover:-translate-y-2 transition-all 12xl:w-[35rem] 14xl:w-[40rem] mx-auto items-center 12xl:items-start">
