...
const Team_card = ({
  ...
  return (
    <div className="hover:-translate-y-2 transition-all h-100 w-100 inline-block text-center m-5 hover:bg-[#B7D7E5] shadow-md px-8 py-5 rounded-md  text-black/90">
      {role ? (
